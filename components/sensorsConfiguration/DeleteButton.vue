...
<template>
  <ConfirmDialog :title="`Elminiar ${props.sensorConfiguration.name}`" :content="`¿Confirma que desea eliminar la configuración ${props.sensorConfiguration.name}? Si tienes algún sensor activo dejará de transmitir.`" :on-success="onDeleteLocation">
