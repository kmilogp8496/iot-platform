...
<template>
  <ConfirmDialog :title="`Eliminar ${props.actuatorConfiguration.name}`" :content="`¿Confirma que desea eliminar el actuador ${props.actuatorConfiguration.name}? Si tienes algún actuador activo dejará de recibir información de esta configuración.`" :on-success="onDeleteLocation">
